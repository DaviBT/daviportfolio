...
function adivNum(){
    ...
    if (userNum == ramdomNum){
        boxResult.innerHTML = "Parabéns, você conseguiu!"
        boxResult.style.setProperty("background-color", "green");
    } else if (userNum > ramdomNum){
        boxResult.innerHTML = "O número que você digitou foi muito grande, tente novamente"
        boxResult.style.setProperty("background-color", "red");
    } else if (userNum < ramdomNum){
        boxResult.innerHTML = "O número que você digitou foi muito pequeno, tente novamente"
        boxResult.style.setProperty("background-color", "red");
    }
};